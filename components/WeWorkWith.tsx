        ...
        <div className="gallery_our_brand">
          <div className="brand_bl">
            <motion.div style={{ y: y1 }} className="div-block-672">
              <img
                width="988.5"
                sizes="(max-width: 991px) 100vw, 988.5px"
                alt=""
                src="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dc12db164920f9e80e42_ipad_01_1.webp"
                loading="lazy"
            ...
            <motion.div style={{ y: y2 }} className="div-block-673">
              <img
                width="431"
                sizes="(max-width: 479px) 100vw, 431px"
                alt=""
                src="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dc0ddb164920f9e80a68_iphone_01.webp"
                loading="lazy"
                srcSet="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dc0ddb164920f9e80a68_iphone_01.webp 500w, https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dc0ddb164920f9e80a68_iphone_01.webp 862w"
              />
            </motion.div>
            ...
            <motion.div style={{ y: y3 }} className="div-block-674">
              <img
                ...
                alt=""
                src="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dc0fdb164920f9e80c17_desk_1.webp"
                loading="lazy"
            ...
            <motion.div style={{ y: y4 }} className="div-block-675">
              <img
                width="963"
                sizes="(max-width: 991px) 100vw, 963px"
                alt=""
                src="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dbd2457ca138735310f7_ipad_03.webp"
                loading="lazy"
            ...
            <motion.div style={{ y: y5 }} className="div-block-677">
              <img
                width="1634"
                sizes="(max-width: 1919px) 100vw, 1634px"
                alt=""
                src="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dbe0457ca13873531a11_mac_frame_b.webp"
                loading="lazy"
            ...
            <motion.div style={{ y: y6 }} className="div-block-678">
              <img
                width="439"
                sizes="(max-width: 479px) 100vw, 439px"
                alt=""
                src="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dc08db164920f9e8071e_iphone_02.webp"
                loading="lazy"
                srcSet="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dc08db164920f9e8071e_iphone_02.webp 500w, https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dc08db164920f9e8071e_iphone_02.webp 878w"
              />
            </motion.div>
            ...
            <motion.div style={{ y: y1 }} className="div-block-679">
              <img
                width="765"
                sizes="(max-width: 767px) 100vw, 765px"
                alt=""
                src="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dbd1457ca13873530f1b_ipad_04.webp"
                loading="lazy"
            ...
            <motion.div style={{ y: y3 }} className="div-block-680">
              <img
                ...
                alt=""
                src="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dbca457ca13873530987_Ipad_05.webp"
                loading="lazy"
            ...
            <motion.div style={{ y: y5 }} className="div-block-681">
              <img
                ...
                sizes="(max-width: 1919px) 100vw, 1634px"
                alt=""
                src="https://cdn.prod.website-files.com/667a7576e7e7ef3ba89b3f2a/66c6dbcb457ca13873530a16_macbook_02.webp"
                loading="lazy"
