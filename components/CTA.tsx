  ...
  return (
    <section data-nav-dark className="bg-[#080808] px-6 pb-12 pt-4" id="contact">
      <div className="mx-auto max-w-[1350px]">
        <div className="relative overflow-hidden rounded-3xl bg-[#101010] px-6 py-12 md:px-12 md:py-16">
          ...
          <div className="flex flex-col items-start gap-8 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex w-full max-w-[480px] flex-col">
              <h2
                ...
                style={{ fontSize: 'clamp(2.5rem, 7.8vw, 112px)', lineHeight: '1' }}
              >
                Innovate
                <br />
                with us
              </h2>
              <p className="mt-5 text-[15px] leading-relaxed text-[#737373]">
              ...
              <div className="mt-8 flex w-full flex-col gap-3 md:flex-row md:gap-4">
                ...
                <Link
                  ...
                  className="group relative overflow-hidden rounded-full bg-[#f05a28] px-7 py-4 text-center text-sm font-medium text-white md:py-3.5"
                >
                ...
                {/* Book a call — dark */}
                <button
                  className="group relative overflow-hidden rounded-full bg-[#2a2a2a] px-7 py-4 text-center text-sm font-medium text-white md:py-3.5"
                >
                  <span className="relative z-10">Book a call</span>
                  <span
                    aria-hidden="true"
                    className="pointer-events-none absolute left-1/2 top-1/2 h-2 w-2 -translate-x-1/2 -translate-y-1/2 scale-0 rounded-full bg-[rgba(255,255,255,0.1)] transition-transform duration-[600ms] group-hover:scale-[36]"
                    style={{ transitionTimingFunction: 'cubic-bezier(0.455,0.03,0.515,0.955)' }}
                  />
                </button>
              </div>
